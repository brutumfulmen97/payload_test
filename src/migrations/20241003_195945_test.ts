...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  DO $$ BEGIN
   ALTER TABLE "slider_slider" ADD CONSTRAINT "slider_slider_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "slider_slider" ADD CONSTRAINT "slider_slider_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."slider"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "slider_slider_order_idx" ON "slider_slider" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "slider_slider_parent_id_idx" ON "slider_slider" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "slider_created_at_idx" ON "slider" USING btree ("created_at");
